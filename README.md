...
[GITHUB Pages](https://BudTon.github.io/ra_router_crud/)

[![pages-build-deployment](https://github.com/BudTon/ra_hooks-context_use-json-fetch/actions/workflows/pages/pages-build-deployment/badge.svg)](https://github.com/BudTon/ra_router_crud/actions/workflows/pages/pages-build-deployment)

Вам необходимо реализовать CRUD при работе с HTTP с использованием Router.

Backend вы можете либо написать сами, либо взять готовый из каталога `server`.
Server реализован на render.com
